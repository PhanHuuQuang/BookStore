               ...
               <form action="update_cart" method="post" id="cartForm">
                 <div>
                    <table border="1">
                        ...
                        <tr>
                        	<td colspan="3" align="left"><b>Book Total:</b></td>
                            <td align="right"><b>${cart.totalQuantity} book(s)</b></td>
                            <td align="left"><b>Total:</b></td>
                            <td><b>$<fmt:formatNumber value="${cart.totalAmount}"/></b></td>
                   ...
                   <div>
                      <table class="normal">
                         ...
                         <tr>
                             ...
                             <td><a href="${pageContext.request.contextPath}/"><input type="button" value="Continue Shopping" /></a><td>
                             <td><a href="checkout"><input type="button" value="Checkout" /></a></td>
                         </tr>
                      </table>
                   </div>  
               </form>
