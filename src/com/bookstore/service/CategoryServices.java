...
public class CategoryServices {
	...
	public void updateCategory() throws ServletException, IOException {
		...
		if (categoryByName != null) {
			String message = "Could not update category." + " A category with name " + categoryByName.getName() + " already exists.";
			request.setAttribute("message", message);
	...
	public void deleteCategory() throws ServletException, IOException {
		...
		long number = bookDAO.countByCategory(categoryId);
		String message;
		
		if (number > 0) {
			message = "Could not delete because it contains some books";
		} else {
