...
public class PaymentServices {
	...
	private static final String CLIENT_ID = "Ae5-BThTkVoclYC97bNDlngYiv6G4XQ_Q6fJrSPAjC-aTFPuLW1iTnC4IFLEphUF0-R-35o5Full4gGy";
	private static final String CLIENT_SECRET = "EIoDQEWwllfjFHKl6oGsO7pTcEyjQT9x-a6G4p6wHSifQsb8uV9rzVCUd7jFdFtVeAfY7NzT4JlC8gPx";
	...
	private Amount getAmountDetails(BookOrder order) {
		...
		details.setSubtotal(String.format("%.2f",order.getTotal()));
